...
/** downloadFile GET /api/file/download/${param1}/${param0} */
export async function downloadFileUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.downloadFileUsingGETParams,
  options?: { [key: string]: any },
) {
  const { fileName: param0, fileType: param1, ...queryParams } = params;
  return request<API.BaseResponseBoolean_>(`/api/file/download/${param1}/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  });
